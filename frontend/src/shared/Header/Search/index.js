    ...
    <div>
      ...
      <div>
        <form>
          ...
          <label>
            <Select options={categories} openMenuOnClick={false} placeholder='Choose a Category' onChange={onDropdownChange} />
          </label>
          <label>
            <Select options={times} openMenuOnClick={false} placeholder='Choose a Time Period' onChange={onDropdownChangeForTime} />
          </label>
          <button type='submit' onClick={submitSelectedCategory}>
            {' '}
            Search
          </button>
        </form>
